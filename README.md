...
| **OpenHands** | Open-source AI agent platform with a web UI, supporting custom LLM profiles and isolated workspaces for coding agents. | [Guide](./docs/openhands.md) |
