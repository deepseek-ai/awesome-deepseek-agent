...
| **go-stock** | Open-source desktop stock-analysis tool with a built-in AI agent (React / Plan-Execute / DeepAgents) and 150+ financial data tools. | [Guide](./docs/go-stock.md) |
