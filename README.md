...
| **Gliding Horse** | Open-source industrial-grade AI agent operating system in Rust with PDCA orchestration, knowledge graph, and a terminal coding assistant (Gliding Code) — native DeepSeek Responses API support, 1M context. | [Guide](./docs/gliding-horse.md) |
