...
| **GoRaven** | Open-source self-hosted team Agent platform with isolated workspaces, skills marketplace, knowledge bases, and MCP toolchains. | [Guide](./docs/goraven.md) |
