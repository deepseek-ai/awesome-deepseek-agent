...
| **DeepSeekFathom** | Open-source DeepSeek-first coding agent with a Windows desktop app, cross-platform CLI, MCP, plugins, Hooks, Skills, resumable sessions, 1M context, and native max reasoning. | [Guide](./docs/deepseekfathom.md) |
