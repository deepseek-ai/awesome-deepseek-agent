...
| **rtrvr.ai** | Browser-native AI web agent for scraping, form filling, monitoring, and multi-step automation with BYO DeepSeek API Key support. | [Guide](./docs/rtrvr.md) |
