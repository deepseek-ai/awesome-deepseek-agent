...
| **DeepSeek Harness** | DeepSeek's own agent harness — everything is a plugin, composed from a cordis.yml profile, running on the DeepSeek API (deepseek-v4-pro / deepseek-v4-flash, 1M context). | [Guide](./docs/deepseek_harness.md) |
