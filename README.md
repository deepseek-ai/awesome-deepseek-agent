...
| **Open Science** | Open-source desktop AI workbench for scientific research, with sandboxed agent runtimes, notebooks, Skills, Connectors, and built-in DeepSeek V4 support. | [Guide](./docs/openscience.md) |
