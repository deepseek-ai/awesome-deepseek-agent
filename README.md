...
| **Orcana** | DeepSeek-native terminal coding agent runtime with planning gates, patch transactions, evidence-based completion, and an interactive TUI for long-running coding tasks. | [Guide](docs/orcana.md) |
