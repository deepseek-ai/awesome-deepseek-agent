...
| **DS Agent** | DeepSeek-first local Windows work agent with memory, automation, permissioned local tools, verified computer use, and auditable execution. | [Guide](./docs/ds_agent.md) |
