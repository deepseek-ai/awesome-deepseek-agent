...
| **Harness Desktop** | Community Windows desktop app for the official DeepSeek Harness workspace with themes, an in-app plugin marketplace, and desktop updates. | [Guide](./docs/harness_desktop.md) |
