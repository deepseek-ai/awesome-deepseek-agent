...
| **dscli** | AI-enhanced developer toolbox with AI chat, tool calling (file ops, Git), code completion, project-aware context, and multi-format output. | [Guide](./docs/dscli.md) |
