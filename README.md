...
| **deepseek-kit** | Lightweight Agent framework with native-level DeepSeek adaptation — precise tool calling in thinking mode, reliable structured output, maximum cache hit rate. | [Guide](./docs/deepseek-kit.md) |
