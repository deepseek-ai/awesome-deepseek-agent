...
| **HanaAgent/OpenHanako** | Cross-platform personal AI agent with memory, personality, multi-agent collaboration, plugins, bridge integrations, sandboxed tools, DeepSeek V4 thinking support, cache-friendly prompt freezing, and optional auxiliary vision for image understanding. | [Guide](./docs/hanaagent.md) |
