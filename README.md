...
| --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------ |
| **AionUi** | Free, open-source Cowork app with multiple AI Agents that read files, write code, browse the web, and generate Office docs — works with any API key. | [Guide](./docs/aionui.md) |
