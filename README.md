...
| **QevosAgent** | Open-source autonomous AI agent framework with web Dashboard, multi-model support, tool registration, and long-term memory. | [Guide](./docs/qevosagent.md) |
