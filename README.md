...
| **Nexent** | Zero-code agent auto-generation platform — build agents with natural language, supporting knowledge bases, MCP tools, multimodal interaction, and multi-model integration including DeepSeek. | [Guide](./docs/nexent.md) |
