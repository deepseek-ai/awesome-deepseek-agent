...
| **Taishen** | Desktop AI workbench purpose-built for DeepSeek with Commander agent engine, IM remote access (Feishu/WeChat/QQ), and Skill/MCP ecosystem. | [Guide](./docs/taishen.md) |
