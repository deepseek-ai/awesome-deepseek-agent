...
| **AtomCode** | Open-source terminal AI coding agent written in Rust that connects to any OpenAI-compatible API, with an autonomous agent loop, code graph tools, and session persistence. | [Guide](./docs/atomcode.md) |
