...
| **DeepSeek Code Agent** | Open-source Web UI coding assistant for rapid development — lightweight client, one-click Pro/Flash switching, transparent decision-making, ideal for beginners and advanced Agent learners. | [Guide](./docs/deepseek_code_agent.md) |
