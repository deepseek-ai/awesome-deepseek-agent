...
| **MateClaw** | Personal AI operating system — one DeepSeek brain across web and IM channels (DingTalk, Feishu, WeChat Work, Telegram, Discord, QQ, Slack), with Skills, Memory, MCP, Tool Guard, and a Wiki engine. Built on Spring AI Alibaba. | [Guide](./docs/mateclaw.md) |
