...
| **IllusionCode** | Open-source terminal AI coding assistant inheriting Claude Code's prompt system, with dual UI (terminal + web), multi-provider support, MCP, plugin/skill systems, and bilingual UI. | [Guide](./docs/illusion_code.md) |
