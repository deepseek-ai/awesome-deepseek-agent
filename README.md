...
| **Rekall** | Identity compression layer for persistent agent memory — 刃. Strips RLHF noise, compresses context to CN (~100:1), preserves tool calls verbatim. Transparent proxy, no agent changes needed. | [Guide](./docs/rekall.md) |
