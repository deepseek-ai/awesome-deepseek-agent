...
| --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------ |
| **Agent-in-Terminal** | Ultra-lightweight Linux terminal agent — single Python file, encrypted key storage, one gated shell tool. | [Guide](./docs/agent_in_terminal.md) |
