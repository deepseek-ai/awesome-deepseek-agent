...
| **Tiangong**    | Open-source personal AI agent platform with desktop GUI, CLI, server, multi-agent collaboration, MCP, Skills, and cross-session memory system. | [Guide](./docs/tiangong.md) |
