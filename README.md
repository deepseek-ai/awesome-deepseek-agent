...
| **KinetAios** | Local-first, multi-engine AI agent dashboard running Direct (V1/V2/V3), Claude Code, Codex, and DeepSeek Harness side-by-side, with cross-engine long-term memory and a built-in MCP server. | [Guide](./docs/kinetaios.md) |
