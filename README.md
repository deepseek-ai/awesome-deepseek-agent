...
| **TideCode** | Desktop AI workspace for efficient software development with Agent and Plan modes, project tools, Git/GitHub, MCP, skills, and DeepSeek V4 support. | [Guide](./docs/tidecode.md) |
