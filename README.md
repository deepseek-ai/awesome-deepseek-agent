...
| **DimCode** | Multi-model AI coding agent available as a desktop app and terminal TUI, with long-running stable execution and ACP protocol support. | [Guide](./docs/dimcode.md) |
