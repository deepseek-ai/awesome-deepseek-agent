...
| **dph-fleet** | Open-source DeepSeek Harness (dsh) plugin that turns devices into a fleet — mDNS LAN discovery, key pairing, SSH cross-network execution, and file transfer, callable by dsh agents. | [Guide](./docs/dph_fleet.md) |
