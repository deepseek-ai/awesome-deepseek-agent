...
| **Synergy** | Open-source AI agent workspace — persistent sessions, Web/Desktop/CLI workbench, and native support for tools, MCP, Browser, and automation. | [Guide](./docs/synergy.md) |
