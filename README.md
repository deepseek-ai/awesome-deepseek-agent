...
| **DeepSeek Harness** | DeepSeek's own agent harness built on Cordis — everything is a plugin, with a community ecosystem of 12,000+ plugins. | [Guide](./docs/deepseek_harness.md) |
