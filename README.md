...
| **DSH Cloud** | Open-source platform that turns DeepSeek Harness into a multi-user product — accounts, credit metering, a server-side model gateway, and cloud agent workspaces. | [Guide](./docs/dsh_cloud.md) |
