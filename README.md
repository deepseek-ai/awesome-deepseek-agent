...
| **Waveloom** | Open-source Go terminal coding agent with DeepSeek V4 as the default LLM — thinking mode, reasoning effort control, 1M context with prefix-stable compaction. | [Guide](./docs/waveloom.md) |
