...
| **ToCodex** | Open-source enterprise-grade general-purpose AI coding agent (desktop, VS Code, CLI) with DeepSeek as a built-in provider, 1M context, and adjustable reasoning effort. | [Guide](./docs/tocodex.md) |
