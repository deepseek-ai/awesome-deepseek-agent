...
| --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------ |
| **Aurora** | One account, one gateway — every supported agent and client reaches the world's models. Import your own DeepSeek key, then build from Aurora Assistant or your existing client. | [Guide](./docs/aurora.md) |
