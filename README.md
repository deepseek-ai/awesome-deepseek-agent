...
| **lite-code** | Open-source desktop Code Agent with a hand-written Python kernel — 20 built-in tools, sandbox approvals, and DeepSeek as the default provider. | [Guide](./docs/lite_code.md) |
