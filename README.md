...
| **Xpro** | Open-source AI-powered desktop IDE with autonomous agent mode, project memory, sub-agents, visual annotation, and thinking mode. Built on Electron + Rust. | [Guide](./docs/xpro.md) |
