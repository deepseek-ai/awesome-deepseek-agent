...
| **CCX**         | High-performance API proxy & protocol gateway enabling Codex CLI and Codex App to use DeepSeek via local message passthrough and Responses→Chat translation. | [Guide](./docs/ccx.md) |
