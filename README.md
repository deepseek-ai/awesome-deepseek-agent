...
| **yoyo** | Self-evolving open-source terminal coding agent in Rust — 90+ slash commands, subagent orchestration, MCP and skills; it writes its own code in public. | [Guide](./docs/yoyo.md) |
