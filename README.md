...
| **DeepDepCat** | Open-source desktop AI workbench with dual workspaces — a Claude Code-style coding agent and a Codex-style document/office-automation agent, multi-session parallelism, subagent orchestration, and 1M context. | [Guide](./docs/deepdepcat.md) |
