...
| **Cortex Desktop** | Local-first macOS AI workstation that listens, speaks, and acts — voice, computer use, subagents, with DeepSeek in its built-in model catalog. | [Guide](./docs/cortex_desktop.md) |
