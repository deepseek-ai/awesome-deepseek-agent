...
| **DeepDepCat** | All-in-one desktop AI workbench with coding and document/office-automation workspaces, multi-session parallelism, subagent orchestration, ecosystem skill reuse, and 1M context. | [Guide](./docs/deepdepcat.md) |
