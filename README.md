...
| **DeepSeek-CLI** | Open-source agentic terminal AI coding assistant for DeepSeek — 14 built-in tools, MCP, skills, and sub-agents in a single ~60 MB binary. | [Guide](./docs/deepseek-cli.md) |
