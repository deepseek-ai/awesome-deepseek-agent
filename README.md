...
| **Nika** | Intent-as-code workflow engine (Rust): reviewable YAML DAGs checked for schema, permits and cost before any token is spent — DeepSeek is a first-class provider. | [Guide](./docs/nika.md) |
