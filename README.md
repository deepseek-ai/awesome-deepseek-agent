...
| **DeepSeek Harness for GitHub** | Community-maintained GitHub Action for PR review, CI diagnosis, and Issue → PR automation with DeepSeek Harness. | [Guide](./docs/deepseek-harness-github.md) |
