...
| **Qwen Code** | An open-source terminal AI agent that helps you understand large codebases, automate tedious tasks, and accelerate delivery | [Guide](./docs/qwen_code.md) |
## Resources
