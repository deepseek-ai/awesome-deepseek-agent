...
| **AICraft** | Windows desktop AI capability launcher with built-in one-click DeepSeek setup, MCP support, deep thinking toggle, and auto model routing. Portable exe, no installation. | [Guide](./docs/aicraft.md) |
