...
| **MSS-Agent** | First open-source Agent framework with built-in "meaning-field self-audit" — rejects meaningless tasks before calling LLM. | [Guide](./docs/mss-agent.md) |
