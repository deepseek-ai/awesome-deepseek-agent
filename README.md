...
| **Taco AI** | Open-source desktop AI assistant with built-in terminal, code editor, browser automation, and project memory — a full operating environment for DeepSeek on desktop. | [Guide](./docs/taco.md) |
