...
| **DeepAgent Studio** | Open-source, DeepSeek-native agent runtime with a Tauri desktop IDE, durable sessions, tool approvals, MCP, skills, and sub-agent orchestration. | [Guide](./docs/deepagent_studio.md) |
