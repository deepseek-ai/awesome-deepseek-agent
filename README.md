...
| **DeepSeekCode** | Local-first AI coding agent (TypeScript/Bun) with terminal, web, and desktop UIs — dual-paradigm ReAct/workflow routing, risk-tiered permissions, auto-fix test loop, MCP, and IM-channel approvals. | [Guide](./docs/deepseekcode.md) |
