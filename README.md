...
| **ZCode (Zhipu)** | Agentic development environment (ADE) by Zhipu AI that combines AI agents with your existing toolchain; add DeepSeek as a custom provider. | [Guide](./docs/zcode-ade.md) |
