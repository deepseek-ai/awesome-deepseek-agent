...
| **DeepSeek Code Agent** | Browser UI + FastAPI host for DeepSeek tool calling; `config.ini`, optional `/immersive` layout, session encryption modes. | [Guide](./docs/deepseek_code_agent.md) |
