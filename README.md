...
| **Markus**      | Open-source AI Digital Employee Platform — DeepSeek built-in, create and manage persistent AI agents with skills, tasks, and human-in-the-loop governance. | [Guide](./docs/markus.md) |
