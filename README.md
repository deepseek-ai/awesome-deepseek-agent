...
| **CodeWhale (formerly DeepSeek-TUI)** | DeepSeek-first open-source Rust terminal coding agent with native DeepSeek V4 support, reasoning effort control, sandboxed tools, MCP client/server, 1M context, and local/open-model provider compatibility. | [Guide](./docs/codewhale.md) |
