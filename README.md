...
| **deepx-code** | DeepSeek-native terminal coding agent in Go — small & fast, automatic context compaction, built-in code graph, local image OCR, MCP, and flash/pro auto-routing. | [Guide](./docs/deepx-code.md) |
