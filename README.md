...
| **Tokeny** | Cross-platform desktop AI assistant with built-in DeepSeek support, a Skill system, MCP plugins, and built-in tools (files, commands, web search). | [Guide](./docs/tokeny.md) |
