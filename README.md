...
| **DeepSeek Code** | Open-source DeepSeek-powered terminal coding agent with full TUI, multi-provider support (DeepSeek, Bedrock, Vertex, local), MCP, LSP, and Agent Skills. Published as `@hermenics/deepseek-code`. | [Guide](./docs/deepseek_code.md) |
