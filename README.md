...
| **Snow CLI**            | Open-source agentic AI terminal coding assistant — full VSCode & JetBrains plugins, local offline codebase, and adapters for every DeepSeek API request mode. | [Guide](./docs/snow-cli.md)       |
