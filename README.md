...
| **Deep Copilot** | Open-source AI coding agent embedded in VS Code, powered by DeepSeek V4. Supports agentic file editing, shell, web search, MCP client, Plan/Todos panel, and parallel sessions. No backend required. | [Guide](./docs/deepcopilot.md) |
