...
| **DeepSeek Code Agent** | Browser-based DeepSeek V4 agent with built-in tools, multi-agent collaboration, knowledge base, and immersive multi-tab layout. Zero IDE dependency — configure and run in minutes. | [Guide](./docs/deepseek_code_agent.md) |
