...
| **MamboChat** | Open-source web harness platform with multi-provider API support, Mambo Agent, RAG knowledge bases, and MCP — accessible from desktop and mobile browsers. | [Guide](./docs/mambochat.md) |
