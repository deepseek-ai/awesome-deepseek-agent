...
| **Tianshu** | Open-source agentic coding assistant in terminal and desktop form — built-in DeepSeek provider, 1M context, max reasoning effort. | [Guide](./docs/tianshu.md) |
