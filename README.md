...
| **Polaris** | Cross-platform AI development workspace with built-in coding agent engines (Claude Code, Codex, Simple AI, Pi, Mimo) and a flexible Model Provider system. | [Guide](./docs/polaris.md) |
