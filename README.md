...
| **Eval Agent** | DeepSeek-compatible embedded-engineering agent that connects specialist agents with tools for schematics, firmware, build, flashing, serial, and SWD debugging. | [Guide](./docs/eval_agent.md) |
