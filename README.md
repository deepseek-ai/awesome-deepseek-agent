...
| --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------ |
| **anyCode** | Open-source (MIT) Rust agent workbench — local-first Digital Workbench with a single AgentRuntime, BYOK models, built-in DeepSeek catalog, tools, MCP, LSP, Skills, and cron. | [Guide](./docs/anycode.md) |
