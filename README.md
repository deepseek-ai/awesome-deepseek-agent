...
| **Gritcode** | Open-source native desktop AI coding agent for macOS and Linux (C++, no Electron) with a file tree, editor, 1M context, and DeepSeek reasoning effort control. | [Guide](./docs/gritcode.md) |
