...
| **IllusionCode** | Open-source terminal AI coding assistant inheriting Claude Code's prompt system, with multi-provider support, MCP, bilingual UI, and markdown rendering. | [Guide](./docs/illusion_code.md) |
