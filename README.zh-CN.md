...
| **Gliding Horse** | 开源的工业级 AI Agent 操作系统，基于 Rust 构建，支持 PDCA 编排、知识图谱，并内置终端编程助手 Gliding Code —— 原生支持 DeepSeek Responses API 与 100 万 token 上下文。 | [指南](./docs/gliding-horse.zh-CN.md) |
