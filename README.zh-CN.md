...
| **MateClaw** | 个人 AI 操作系统 —— 同一个 DeepSeek 大脑跨 Web 与即时通讯渠道（钉钉、飞书、企业微信、Telegram、Discord、QQ、Slack），内置 Skills、Memory、MCP、Tool Guard 与 Wiki 引擎，基于 Spring AI Alibaba。 | [指南](./docs/mateclaw.zh-CN.md) |
