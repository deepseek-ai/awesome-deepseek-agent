...
| **DeepSeek Harness** | DeepSeek 官方 agent harness —— 一切皆插件，由 cordis.yml profile 组装，运行于 DeepSeek API（deepseek-v4-pro / deepseek-v4-flash，1M 上下文）。 | [指南](./docs/deepseek_harness.zh-CN.md) |
