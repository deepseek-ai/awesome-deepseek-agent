...
| **CodeWhale（原 DeepSeek-TUI）** | DeepSeek-first 的开源 Rust 终端编程 Agent，原生支持 DeepSeek V4、推理强度控制、沙箱化工具、MCP 客户端/服务器、100 万 token 上下文，并兼容本地与开放模型 provider。 | [指南](./docs/codewhale.zh-CN.md) |
