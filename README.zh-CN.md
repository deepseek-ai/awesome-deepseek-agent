...
| **DeepSeek Code** | 开源的 DeepSeek 驱动终端编程 Agent，具备完整 TUI、多供应商支持（DeepSeek、Bedrock、Vertex、本地模型）、MCP、LSP 与 Agent Skills。发布为 `@hermenics/deepseek-code`。 | [指南](./docs/deepseek_code.zh-CN.md) |
